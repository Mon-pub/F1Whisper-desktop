...
/**
 * Returns common ESlint config rules for the given root path of a specific package.
 *
        ...
        // Rules for all files.
        {
            rules: {
                'import/no-extraneous-dependencies': [
                    'error',
                    {
                        // Config files are allowed to use `devDependencies`.
                        devDependencies: ['*.config.*'],
                        peerDependencies: false,
                        bundledDependencies: false,
                        packageDir: packageRootPath,
                    },
                ],
            },
        },
 ...
 * @returns {Linter.Config<Linter.RulesRecord>["rules"]}
 */
export function getTypeScriptConfigMixin(
    /** @type {"svelte" | "ts"} */ extension,
    /** @type {Linter.Config<Linter.RulesRecord>} */ override,
) {
    const namingConvention = /** @type {[Linter.RuleSeverity, ...any[]]} */ ([
        'error',
